    ...
    <View style={{backgroundColor:"#021024"}}>
     ...
     <View style={{justifyContent: "flex-end",height: '100%'}}>
       <View style={{backgroundColor:"#D9D9D9", paddingTop:50, paddingHorizontal: 20, height: '95%', borderTopRightRadius: 50, borderTopLeftRadius: 50,}}>
        ...
        <Text style={{fontSize:24,fontWeight:"Semibold",alignSelf:"center",paddingTop:30}}>Reset Via Email </Text>
        <Icon
          name={"mail-outline"}
          size={30}
          position={"absolute"}
       ...
       <Text style={{fontSize:24,fontWeight:"Semibold",alignSelf:"center",paddingTop:30}}>Reset Via Sms</Text>
        <Icon
